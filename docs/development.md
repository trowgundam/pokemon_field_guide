...
- resolves TM numbers and moves from the 50 aliases in `include/constants/items.h`;
- emits Seagallop Ferry transport markers for all seven main islands, Navel Rock, and Birth Island;
